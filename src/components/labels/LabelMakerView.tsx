                    ...
                    >
                      ...
                      <div className="space-y-4">
                        {sheetBooks.map((book) => (
                          <div
                            key={book.id}
                            className="p-3 bg-white rounded-lg border-2 border-dashed border-neutral-400 flex flex-row items-stretch justify-start gap-4 print:p-2 print:border-black print:page-break-inside-avoid relative"
                          >
                            {/* Cut guide badge */}
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {sheetBooks.map((book) => (
                          <div
                            key={book.id}
                            className="p-2 bg-white rounded-lg border-2 border-dashed border-neutral-400 flex flex-col gap-2 print:border-black print:page-break-inside-avoid relative"
                          >
