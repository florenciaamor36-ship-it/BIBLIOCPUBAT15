          ...
          <div className="pt-4 border-t border-slate-800 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <button
                ...
                onClick={async () => {
                  try {
                    const response = await fetch('https://api.jsonbin.io/v3/b/6a96e75ada38895dfe2b7db0/latest', { headers: { 'X-Access-Key': '$2a$10$FxRzpQtNnYAa6/vpqBCkEea6qyNYJALCybErbZhSJvY/CR/m1gQRO' } });
                    if (response.ok) {
